      ...
      <div v-if="codeFlag">
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" @submit.native.prevent>
                ...
                <el-form-item>
                    ...
                    <button :disabled="!checked" class="buttonR" @click="submitForm('ruleForm')">确认注册</button>
...
<script>
import {_InsertAdmin} from "../network/admin"
export default {
    name:"adminRegister",
        data() {
    ...
    methods: {
      ...
      userInsert(userName,password){
          _InsertAdmin(userName,password).then(res=>{
